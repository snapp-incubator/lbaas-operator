...
func (in *ExternalServiceStatus) DeepCopyInto(out *ExternalServiceStatus) {
	*out = *in
	if in.ServiceAddresses != nil {
		in, out := &in.ServiceAddresses, &out.ServiceAddresses
...
func (in *Static) DeepCopyInto(out *Static) {
	*out = *in
	if in.Addresses != nil {
		...
		*out = make([]StaticEndpoint, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StaticEndpoint) DeepCopyInto(out *StaticEndpoint) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StaticEndpoint.
func (in *StaticEndpoint) DeepCopy() *StaticEndpoint {
	if in == nil {
		return nil
	}
	out := new(StaticEndpoint)
	in.DeepCopyInto(out)
	return out
}
